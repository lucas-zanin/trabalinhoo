...
namespace SAEP
{
    ...
    public partial class FormLOTE1 : Form
    {
        ...
        private void FormLOTE1_Load(object sender, EventArgs e)
        {
            Lote1 lo = new Lote1();
            List<Lote1> lotes = lo.listalote();
            dgvLote1.DataSource = lotes;
        }

        public void dgvLote1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
